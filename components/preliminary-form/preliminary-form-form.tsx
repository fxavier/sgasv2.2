...
const formSchema = z.object({
  ...
  activity_type: z.enum(['TURISTICA', 'INDUSTRIAL', 'AGRO_PECUARIA', 'ENERGETICA', 'SERVICOS', 'OUTRA']),
  ...
  activity_province: z.enum(['MAPUTO', 'MAPUTO_CITY', 'GAZA', 'INHAMBANE', 'SOFALA', 'MANICA', 'TETE', 'ZAMBEZIA', 'NAMPULA', 'CABO_DELGADO', 'NIASSA']),
  geographic_coordinates: z.string().optional(),
  insertion_point: z.enum(['RURAL', 'URBANO', 'PERIURBANO']),
  territorial_planning_framework: z.enum(['ESPACO_HABITACIONAL', 'INDUSTRIAL', 'SERVICOS', 'OUTRO']),
  ...
  physical_characteristics_of_activity_site: z.enum(['PLANICIE', 'PLANALTO', 'VALE', 'MONTANHA']).optional(),
  predominant_ecosystems: z.enum(['FLUVIAL', 'LACUSTRE', 'MARINHO', 'TERRESTRE']).optional(),
  location_zone: z.enum(['COSTEIRA', 'INTERIOR', 'ILHA']).optional(),
  type_predominant_vegetation: z.enum(['FLORESTA', 'SAVANA', 'OUTRO']).optional(),
  land_use: z.enum(['AGROPECUARIO', 'HABITACIONAL', 'INDUSTRIAL', 'PROTECCAO', 'OUTRO']).optional(),
...
export function PreliminaryFormForm({ open, onOpenChange, form, onClose }: PreliminaryFormFormProps) {
  ...
  const formMethods = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      territorial_planning_framework: form?.territorial_planning_framework || "ESPACO_HABITACIONAL",
      activity_infrastructure: form?.activity_infrastructure || "",
      associated_activities: form?.associated_activities || "",
      construction_operation_technology_description: form?.construction_operation_technology_description || "",
      ...
      raw_materials_type_quantity_origin_and_provenance: form?.raw_materials_type_quantity_origin_and_provenance || "",
      chemicals_used: form?.chemicals_used || "",
      type_origin_water_energy_consumption: form?.type_origin_water_energy_consumption || "",
      ...
      brief_description_on_local_regional_ref_env_situation: form?.brief_description_on_local_regional_ref_env_situation || "",
      physical_characteristics_of_activity_site: form?.physical_characteristics_of_activity_site || undefined,
      predominant_ecosystems: form?.predominant_ecosystems || undefined,
      location_zone: form?.location_zone || undefined,
      type_predominant_vegetation: form?.type_predominant_vegetation || undefined,
      land_use: form?.land_use || undefined,
      existing_infrastructure_around_activity_area: form?.existing_infrastructure_around_activity_area || "",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {form ? "Edit Preliminary Environmental Form" : "New Preliminary Environmental Form"}
          </DialogTitle>
        </DialogHeader>
        <Form {...formMethods}>
          <form onSubmit={formMethods.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Specify other activity type" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Specify other development stage" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter geographic coordinates" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="ESPACO_HABITACIONAL">Espaço Habitacional</SelectItem>
                        <SelectItem value="INDUSTRIAL">Industrial</SelectItem>
                        <SelectItem value="SERVICOS">Serviços</SelectItem>
                        <SelectItem value="OUTRO">Outro</SelectItem>
                      </SelectContent>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe activity infrastructure" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe associated activities" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Construction Operation Technology Description</FormLabel>
                  <FormControl>
                    <Textarea placeholder="Describe construction operation technology" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe main complementary activities" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Raw Materials Type, Quantity, Origin, and Provenance</FormLabel>
                  <FormControl>
                    <Textarea placeholder="Describe raw materials details" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe chemicals used" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Type and Origin of Water and Energy Consumption</FormLabel>
                  <FormControl>
                    <Textarea placeholder="Describe water and energy consumption" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe fuels and lubricants origin" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe other resources needed" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe land ownership" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe location alternatives" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Brief Description of Local/Regional Environmental Situation</FormLabel>
                  <FormControl>
                    <Textarea placeholder="Describe environmental situation" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Physical Characteristics of Activity Site</FormLabel>
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Existing Infrastructure Around Activity Area</FormLabel>
                  <FormControl>
                    <Textarea placeholder="Describe existing infrastructure" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
