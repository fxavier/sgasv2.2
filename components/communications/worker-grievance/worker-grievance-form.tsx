...
const formSchema = z.object({
  ...
  contact: z.string().min(2, "Contact information must be at least 2 characters"),
  prefered_language: z.enum(['PORTUGUESE', 'ENGLISH', 'OTHER']),
  other_language: z.string().optional(),
  grievance_details: z.string().min(10, "Grievance details must be at least 10 characters"),
  unique_identification_of_company_acknowlegement: z.string().min(2, "Identification must be at least 2 characters"),
  name_of_person_acknowledging_grievance: z.string().min(2, "Name must be at least 2 characters"),
  position_of_person_acknowledging_grievance: z.string().min(2, "Position must be at least 2 characters"),
  date_of_acknowledgement: z.string(),
  signature_of_person_acknowledging_grievance: z.string().min(2, "Signature must be at least 2 characters"),
  follow_up_details: z.string().optional(),
  closed_out_date: z.string(),
  signature_of_response_corrective_action_person: z.string().min(2, "Signature must be at least 2 characters"),
  acknowledge_receipt_of_response: z.string().min(2, "Acknowledgement must be at least 2 characters"),
  name_of_person_acknowledging_response: z.string().min(2, "Name must be at least 2 characters"),
  signature_of_person_acknowledging_response: z.string().min(2, "Signature must be at least 2 characters"),
...
export function WorkerGrievanceForm({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      unique_identification_of_company_acknowlegement: grievance?.unique_identification_of_company_acknowlegement || "",
      name_of_person_acknowledging_grievance: grievance?.name_of_person_acknowledging_grievance || "",
      position_of_person_acknowledging_grievance: grievance?.position_of_person_acknowledging_grievance || "",
      date_of_acknowledgement: grievance?.date_of_acknowledgement || format(new Date(), "yyyy-MM-dd"),
      signature_of_person_acknowledging_grievance: grievance?.signature_of_person_acknowledging_grievance || "",
      follow_up_details: grievance?.follow_up_details || "",
      closed_out_date: grievance?.closed_out_date || format(new Date(), "yyyy-MM-dd"),
      signature_of_response_corrective_action_person: grievance?.signature_of_response_corrective_action_person || "",
      acknowledge_receipt_of_response: grievance?.acknowledge_receipt_of_response || "",
      name_of_person_acknowledging_response: grievance?.name_of_person_acknowledging_response || "",
      signature_of_person_acknowledging_response: grievance?.signature_of_person_acknowledging_response || "",
      date_of_acknowledgement_response: grievance?.date_of_acknowledgement_response || format(new Date(), "yyyy-MM-dd"),
    },
  });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      toast({
        title: grievance ? "Grievance updated" : "Grievance created",
        description: grievance
          ? "The worker grievance has been successfully updated."
          : "The worker grievance has been successfully created.",
      });
      ...
      toast({
        title: "Error",
        description: "There was an error saving the worker grievance. Please try again.",
        variant: "destructive",
      });
    }
  };
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Specify other language" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Response Acknowledging Person Signature</FormLabel>
                      <FormControl>
                        <Input placeholder="Enter signature" {...field} />
                      </FormControl>
                      <FormMessage />
