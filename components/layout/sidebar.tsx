  ...
  },
  {
    ...
    submenu: [
      ...
      },
      {
        title: 'Subprojects',
        icon: Package,
        href: '/administration/subprojects',
      },
      {
        title: 'Acçoes imediatas e correctivas',
        icon: Hammer,
        href: '/administration/acoes-imediatas',
      },
      {
        title: 'Incidentes',
        icon: AlertCircle,
        href: '/administration/incidentes',
      },
      {
        title: 'Pessoa envolvida no acidente',
        icon: UserCog,
        href: '/administration/pessoa-envolvida',
      },
      {
        title: 'Pessoa envolvida na investigação',
        icon: Users,
        href: '/administration/pessoa-investigacao',
      },
      {
        title: 'Photo and Document Proving Closure',
        icon: Camera,
        href: '/administration/photo-document-closure',
      },
      {
        title: 'Acceptance Confirmation',
        icon: FileCheck,
        href: '/administration/acceptance-confirmation',
      },
      {
        title: 'Position',
        icon: Award,
        href: '/administration/position',
      },
      {
        title: 'Toolbox talks',
        icon: BookOpen,
        href: '/administration/toolbox-talks',
      },
      {
        title: 'Trainings',
        icon: GraduationCap,
      ...
      },
      {
        ...
        icon: TreePine,
        href: '/administration/biodiversity-resources',
      },
      {
        title: 'Environmental Factors',
        icon: Leaf,
        href: '/administration/environmental-factors',
      },
      {
        title: 'Risks and Impacts',
        icon: AlertTriangle,
        href: '/administration/risks-and-impacts',
      },
      {
        title: 'Departments',
        icon: Building2,
