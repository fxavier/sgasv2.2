...
const formSchema = z.object({
  ...
  training_area: z
    .string()
    .min(2, 'Training area must be at least 2 characters'),
  training_title: z
    .string()
  ...
  number_of_trainees: z
    .number()
    .min(1, 'Number of trainees must be at least 1'),
  training_recipients: z
    .string()
    .min(2, 'Training recipients must be at least 2 characters'),
  ...
  useEffect(() => {
    if (plan) {
      form.reset({
        ...
        training_entity: plan.training_entity,
        duration: plan.duration,
        number_of_trainees: plan.number_of_trainees,
        training_recipients: plan.training_recipients,
        training_month: plan.training_month,
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      toast({
        title: 'Error',
        description:
          'There was an error saving the training plan. Please try again.',
        variant: 'destructive',
      });
    } finally {
