...
export default function TrainingMatrixPage() {
  ...
  const [editingMatrix, setEditingMatrix] = useState<TrainingMatrix | null>(null);
    ...
    <div className="container mx-auto max-w-6xl px-4 py-6 space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="text-center sm:text-left">
          ...
          <p className="text-gray-500 mt-2">Manage training matrix and effectiveness</p>
        </div>
      ...
      <TrainingMatrixList onEdit={handleEdit} />
