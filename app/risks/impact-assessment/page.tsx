    ...
    <div className="h-full w-full space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="text-center sm:text-left">
          <h1 className="text-3xl font-bold text-gray-900">Environmental & Impact Assessment</h1>
          <p className="text-gray-500 mt-2">Manage and track environmental impacts and risks</p>
        </div>
      ...
      <ImpactAssessmentList onEdit={handleEdit} />
