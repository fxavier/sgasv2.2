...
import { WasteTransferLogForm } from "@/components/monitoring/waste-transfer-log/waste-transfer-log-form";
    ...
    <div className="container mx-auto max-w-7xl px-4 py-6 space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="text-center sm:text-left">
          <h1 className="text-3xl font-bold text-gray-900">FR.AS.031 Waste Transfer Log</h1>
          <p className="text-gray-500 mt-2">Manage and track waste transfer records</p>
        </div>
      ...
      <WasteTransferLogList onEdit={handleEdit} />
