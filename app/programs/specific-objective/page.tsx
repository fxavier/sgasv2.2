...
export default function SpecificObjectivePage() {
  ...
  const [editingObjective, setEditingObjective] =
    useState<SpecificObjective | null>(null);
  ...
  const handleSuccess = () => {
    // Trigger a refresh of the objectives list
  ...
  return (
    <div className='container mx-auto max-w-6xl px-4 py-6 space-y-8'>
      <div className='flex flex-col sm:flex-row justify-between items-center gap-4'>
        <div className='text-center sm:text-left'>
          ...
          <p className='text-gray-500 mt-2'>
            Manage your organization&apos;s specific objectives
          </p>
        </div>
        <Button
      ...
      <SpecificObjectiveList key={refreshKey} onEdit={handleEdit} />
