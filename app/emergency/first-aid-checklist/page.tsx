...
export default function FirstAidKitChecklistPage() {
  ...
  const [editingChecklist, setEditingChecklist] = useState<FirstAidKitChecklist | null>(null);
    ...
    <div className="container mx-auto max-w-7xl px-4 py-6 space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="text-center sm:text-left">
          <h1 className="text-3xl font-bold text-gray-900">First Aid Kit Checklist</h1>
          <p className="text-gray-500 mt-2">Manage and track first aid kit inventory</p>
        </div>
      ...
      <FirstAidKitChecklistList onEdit={handleEdit} />
